...
(function() {
  var colors, getErrCallback, getRequestOptions, getResults, getUrlParameters, grab, grabPaged, promise, request;
  ...
  getRequestOptions = function(criteria) {
    var repoName, requestOptions, urlBase, urlParameters, userName;
    ...
    userName = (typeof criteria.username === 'string' ? criteria.username + '&' : '');
    requestOptions = {
      headers: {
        'User-Agent': 'request'
      }
    ...
    } else if (criteria.repos && isNaN(parseInt(criteria.repos, 10))) {
