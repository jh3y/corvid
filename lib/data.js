(function() {
  ...
  exports.getRequestOptions = getRequestOptions = function(criteria) {
    var repoName, requestOptions, urlBase, urlParameters;
    ...
    } else if (criteria.username && typeof criteria.username === 'boolean' && hasCriteria(criteria)) {
      requestOptions.url = urlBase + 'search/users?' + urlParameters;
    } else if (criteria.username && typeof criteria.username === 'string') {
      requestOptions.url = urlBase + 'search/users?' + urlParameters.replace('user:', '');
    } else if (criteria.username && typeof criteria.username === 'string' && !hasCriteria(criteria)) {
